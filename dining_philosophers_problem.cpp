...
struct Dinner {
    ...
    // Make  forks adjustable
    std::array<Fork, 6> forks;
...
void Philosopher::ponder() {
    static constexpr std::array<const char*, 5> topics {{
        "politics", "art", "meaning of life", "source of morality", "how many straws make a bale"
    }};
...
int main() {
    ...
    std::array<Philosopher, 6> philosophers {{
        ...
        {"Nasser",    dinner, dinner.forks[4], dinner.forks[0]}
    }};
